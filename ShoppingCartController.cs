...
namespace CosmeticsStore.Controllers
{
    ...
    public class ShoppingCartController : Controller
    {
        ...
        private void SendMail(string email, ShoppingCart cart, Models.EF.Order order)
        {
            ...
            CosmeticsStore.Common.Common.SendMail("MinhChienStore", "Đơn hàng #" + order.Code, contentCustomer.ToString(), email);
            ...
            CosmeticsStore.Common.Common.SendMail("MinhChienStore", "Đơn hàng mới #" + order.Code, contentAdmin.ToString(), ConfigurationManager.AppSettings["EmailAdmin"]);
            cart.ClearCart();
        }
        ...
        public ActionResult PaymentVNPay()
        {
            ...
            pay.AddRequestData("vnp_OrderInfo", "Thanh toan don hang - minhchienstore"); //Thông tin mô tả nội dung thanh toán
